...
def parse_args():
    ...
    parser.add_argument("--job_dir", default="./final_path/mae", type=str, help="Job dir. Leave empty for automatic.")
...
def get_shared_folder() -> Path:
    user = os.getenv("USER")
    if Path("/datanfs/liutao/mae/checkpoints/").is_dir():
        p = Path(f"/datanfs/liutao/mae/checkpoints/{user}/experiments")
